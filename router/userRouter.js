...
user_route.get('/forgot-password',auth.isLogin,userController.loadForgotPassword)
user_route.get('/price-sort/:id',auth.isLogin,userController.priceSort)

user_route.post('/resubmit-password',auth.isLogin,userController.resubmitPassword)
